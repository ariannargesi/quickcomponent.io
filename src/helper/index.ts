...
export const getParentNode = ( map: ComponentMember[], key: string, item = null ): ComponentMember => {
...
export const isContentEditable = (value): boolean => {
        return elementsList.filter((item) => item.tag === value)[0]
                .contentEditable
}
